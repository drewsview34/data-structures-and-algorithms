using System;
using Trees15.Classes;
using Xunit;

namespace Trees15XUnitTestProject1
{
    public class UnitTest1
    {
        ...
        [Fact]
        public void AddDuplicatesToLeft()
        {
            BinarySearchTree test = new BinarySearchTree();
        ...
        // Binary Search Tree Contains Tests
        [Fact]
